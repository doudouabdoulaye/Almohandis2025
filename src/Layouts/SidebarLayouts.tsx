...
const SidebarLayout: React.FC<SidebarLayoutProps> = ({ children }) => {
  ...
  return (
    <>
      {/* Le bouton de bascule pour la sidebar sur les écrans mobiles */}
      <button
      ...
      <div className="p-4 sm:ml-64">
        {children} {/* C'est ici que le contenu de Dashboard (DashboardHeader + le reste) sera rendu */}
        {/* Vous pouvez déplacer le contenu statique des cards ici si vous voulez */}
